...
----------------------------' 
    ...
    */
	function email_receipt($order_id) {
		...
		/*$field="ps_multibancos.cfg.php";
		
		require_once("./classes/payment/".$this->$field);*/
		...
		require_once( CLASSPATH.'ps_userfield.php');
		require_once(CLASSPATH.'ps_product.php');
		require_once(CLASSPATH.'payment/ps_multibancos.cfg.php');
		$ps_product = new ps_product;
		...
		elseif (ORDER_MAIL_HTML == '1') {
			...
			if($payment_info_details=="Multibanco")
			{
				$ent_id = MULTI_ENT;
