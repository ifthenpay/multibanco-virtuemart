...
class plgVmPaymentMultibanco extends vmPSPlugin {
    ...
    function __construct(& $subject, $config) {
		...
		$varsToPush = array('entidade' => array(0000, 'char'),
				'subentidade' => array(000, 'char'),
	...
	$SQLfields = array(
		...
		'entity' => ' char(10)  DEFAULT NULL',
		'subentity' => ' char(10)  DEFAULT NULL',
		'value' => ' decimal(15,5) NOT NULL DEFAULT \'0.00\' ',
...
// 		$params = new JParameter($payment->payment_params);
	...
	$order['order_status'] = ((isset($method->status_pending) and $method->status_pending!="" and $method->status_pending!="C")?$method->status_pending:'U');
